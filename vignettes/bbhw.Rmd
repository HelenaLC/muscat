...
* **IHW** : The Independent Hypothesis Weighing (IHW) method 
  ...
  See the `r BiocStyle::Rpackage("IHW")` package for more detail.
...
sel <- unique(unlist(lapply(split(res2$gene, res2$cluster_id), \(x) x[3:150])))
...
```{r}
# here we manually set the nbins because the dataset is too small,
...
This results in a different number of genes with padj<0.05:
