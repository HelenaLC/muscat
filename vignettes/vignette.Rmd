...
If you're not happy with how the plot looks, here's an example of how to modify the `ggplot`-object from above in various ways:
...
Once we have assembled the pseudobulk data, we can test for DS using `pbDS`. By default, a $\sim group_{id}$ model is fit, and the last coefficient of the linear model is tested to be equal to zero.
