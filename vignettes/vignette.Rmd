...
# for each gene in 'top8', plot t-SNE colored by its expression 
...
For changes of high interest, we can view the cell-level expression profiles of a specific gene across samples or groups using `plotExpression` (`r Biocpkg("scater")` package). Here, we generate violin plots for the top-12 DS genes (lowest adj. p-value) in the *B cells* cluster[^2].
